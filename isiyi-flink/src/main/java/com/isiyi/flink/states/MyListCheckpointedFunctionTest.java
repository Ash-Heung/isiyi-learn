 ...
 *
 * @version 1.0.0
 * @description: MyListCheckpointedFunctionTest
 * @author: 向鹏飞
 * @since: 2021/12/21
 */
public class MyListCheckpointedFunctionTest {
...
//        //恢复策略
        ...
        DataStreamSource<String> stringDataStreamSource = env.addSource(new MyListCheckpointedFunction());
