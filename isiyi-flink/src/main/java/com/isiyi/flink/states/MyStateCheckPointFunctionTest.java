 ...
 *
 * @version 1.0.0
 * @description: MyStateCheckPointFunctionTest
 * @author: 向鹏飞
 * @since: 2021/12/21
 */
public class MyStateCheckPointFunctionTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> stringDataStreamSource = env.addSource(new MyStateCheckPointFunction());
